...
public class RssHandler extends DefaultHandler {
    ...
    private final int RSS_LINK = 2;//若是link标签,记做 2
    private final int RSS_DESCRIPTION = 3;//若是description标签,记做 3
    private final int RSS_CATEGORY = 4;//若是category标签,记做 4
    private final int RSS_PUBDATE = 5; //若是pubdate标签,记做 5,注意有两个pubdate,但我们都保存在item的pubdate成员变量中
